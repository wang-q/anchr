...
| `multik-allgroups.md` | 全分组复核（2026-08-15）：按老流程 model.md 的 Q/L × X40/X80 × P + MR 全部 23 组跑 multik——**23/23 组 0 mis、0 N、dup≤1.001**；MR 组全面更优（N50 34-55K、GF 96.1%），X40 N50 优于 X80，Q/L 档位影响小 |
