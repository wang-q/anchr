...
| 新 multik 链 + 主 K 160 | 123,988 | 90 | **98.523** | 1.002 | **0** | 同 5 组 reads，GF +0.16 pp |
...
2. **与外部组装器同口径（5 组）对比**：我们的 N50 123,988 已超过 megahit
   ...
   **主 K 加 160 后**：MG1655 GF 98.364→98.523%（N50 持平，G37 上则
   N50 +45%），详见 `g37-megahit-spades.md` §10。
